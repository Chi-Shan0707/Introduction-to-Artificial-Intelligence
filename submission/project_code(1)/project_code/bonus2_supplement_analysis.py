...
4. Import train_mcts_bonus2_PongImproved.py with a gymnasium stub and generate
   root-action diagnostics without needing to run full 2000-step MCTS episodes.

Usage:
    python bonus2_supplement_analysis.py --project-root path/to/project_ver3 --out-dir bonus2_supplement_outputs
...
"""
# This file is intentionally self-contained. See the delivered package for the
# already generated CSV/PNG outputs. The generation logic mirrors the script used
# to create those outputs in ChatGPT's sandbox.
